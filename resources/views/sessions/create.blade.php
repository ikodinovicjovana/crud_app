    ...
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto">
            ...
            <form action="/sessions" method="POST" class="mt-10">
                @csrf
                <div class="mb-6">
{{--                    <label for="email" class="block mb-2 uppercase font-bold text-xs text-gray-700 mt-5">Email</label>--}}
                    <input class="border border-gray-400 p-2 w-full" type="text" name="email" id="email" value="{{ old('email') }}" placeholder="Email">
                    @error('email')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
{{--                    <label for="password" class="block mb-2 uppercase font-bold text-xs text-gray-700 mt-5">Password</label>--}}
                ...
                <div class="mb-6">
                    ...
                    <a href="/" class="bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500">Register</a>
                </div>
